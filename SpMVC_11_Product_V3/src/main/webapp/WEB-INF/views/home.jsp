...
<body>
	...
	<section class="container-fluid">
		<article class="row d-flex justify-content-center">
			...
			<section class="col-lg-3  col-md-5 col-sm-11 bg-success">
				<form class="was-validated" method="POST"
					...
					/*
						...
						accept="text/plain" : text파일만(*.text)
						accept="text/html" : text파일 중에 *.html
					...
					*/
					%>
					<div class="form-group">
						<input id="p_file" type="hidden" name="p_file"> <label></label> <input
							type="file" class="form-controller" name="u_files" multiple="multiple" accept="image/*" id="u_file">
					</div>
			...
			<div id="p_sub_list" class="col-lg-3  col-md-5 col-sm-11 bg-success">보조정보</div>
