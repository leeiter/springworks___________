...
public interface EmailDao extends CrudRepository<EmailVO, Long> {
	...
	List<EmailVO> findAllByFromEmailAndFromName(@Param("from_email") String from_email, @Param("from_name") String form_name);
	
	List<EmailVO> findAllByFromEmailOrFromName(@Param("from_email") String from_email, @Param("from_name") String form_name);
