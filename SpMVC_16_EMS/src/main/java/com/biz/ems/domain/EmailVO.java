 ...
 * create value : drop and create (위험, 있든 없든 지우고 생성하는 게 자유로움)
...
public class EmailVO {
	 ...
	 * length : 칼럼의 길이
	 * 		지정하지 않으면 DB기본 값으로 255 설정
	 * 칼럼을 생성할 때는 필드변수의 이름과 같이 생성
	 */
	@Column(name = "from_email", nullable = false, length = 40)
	private String fromEmail;
	
	/*
	 * @Column(name = "to_email")
	 * 필드변소와 칼럼의 이름을 달리 설정하고자 할 때
	 */
