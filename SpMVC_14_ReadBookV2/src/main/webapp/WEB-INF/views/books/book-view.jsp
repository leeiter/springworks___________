...
<section>
	<article>
		...
		<div class="book-body">
			<fmt:formatNumber value="${BOOK.b_iprice}" type="number" maxFractionDigits="3" var="commaPrice" />${commaPrice}
			<fmt:formatNumber value="${BOOK.b_iprice}" type="currency" maxFractionDigits="3" var="currPrice" />${currPrice}
			
			<fmt:setLocale value="en_US"/>
			<fmt:formatNumber value="${BOOK.b_iprice}" type="currency" maxFractionDigits="3" var="currPrice"/>
			
			<fmt:formatNumber value="0.1" type="percent" maxFractionDigits="3" var="currPrice"/>
		</div>
	</article>
</section>
