...
public class NaverLoginService {
	...
	private final String callbackLocalURL = "https://localhost:8080/ems/naver/ok";
	private final String callbackURL = "https://callor.com:12600/ems_tlzmfltsu_05/member/naver/ok";
	...
	public NaverTokenVO oAuthAccessGetToken(NaverReturnAuth naverOK) {
		...
		// params에 담긴 정보를
		// HttpEntity 데이터로 변환
		HttpEntity<MultiValueMap<String, String>> request = new HttpEntity<MultiValueMap<String,String>>(badies, headers);
	...
	public NaverMember getNaverMemberInfo(NaverTokenVO tokenVO) {
		...
		// header 문자열의 GET의 http header에 실어서
		// GET 방식으로 요청을 한다.
		HttpHeaders headers = new HttpHeaders();
		 ...
		 * 그리고 Http Procotol을 사용하여 데이터를 전송할 수 있도록
		 * 준비를 한다.
		 * HttpEntity<String> 형식으로 선언하면 : 단일 생성 방식
		 * 
		 * HttpEntity<MultiValueMap<String, Object>> 형식으로 선언하면
