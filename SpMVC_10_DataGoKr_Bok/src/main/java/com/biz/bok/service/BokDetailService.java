...
import com.biz.bok.config.DataGoConfing;
...
public class BokDetailService {
	...
	public String getQueryHeader(String servId) throws UnsupportedEncodingException {
		
		String queryString = bok_url;
		
		queryString += "?crtiKey=" + DataGoConfing.DATA_GO_AUTH; 				//	인증키
	...
	public BokDetailVO getRestResult(String servId) throws UnsupportedEncodingException {
		...
		try {
			...
			// restURI를 서버에 보내서 수신된 xml 형 문자영을
