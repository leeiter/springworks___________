...
static 방식 : 문서파일 형태로 화면을 구현하고, 누구에게나 거의 유사한
	화면을 보여주는 방식
dynamic 방식 : DB, App과 연결되어서 사용자의 요구사항에 따라
...
<body>
<h3>나의 홈페이지</h3>
<p>나(<%= strName %>)의 홈테이지에 오신것을 환영합니다</p>
<p><a href ="https://naver.com/">네이버</a></p>
<p><a href ="https://daum.net/">다음</a></p>
<p><a href ="https://google.com/">구글</a></p>
<!--  strName query로 전달 받은 값을 page.jsp 에게 토스하라 -->
<p><a href ="https://localhost:8080/JSP_02_Hello/page.jsp?strName=<%=strName%>">나의 정보</a></p>
<p><a href ="/JSP_02_Hello/page.jsp?strName=<%=strName%>">나의 정보</a></p>
