		...
		<form method="POST">
			...
			<table class="input">
				<tr>
					...
					<td><input type="text" name="td_subject" value="${todoDTO.td_subject}"></td>
					
					<td>
						<input type="checkbox" id="td_alarm" name="td_alarm" <c:if test="${todoDTO.td_alarm == 'Y'}">checked="checked"</c:if> value="Y">
			...
			<table class="list">
				...
				<c:forEach items="${todoList}" var="todo" varStatus="index">
					<tr>
						...
						<td>
							<a href="${rootPath}/alarm?tdSeq=${todo.td_seq}&tdAlarm=${todo.td_alarm}">${todo.td_alarm}</a>
						</td>
						<td>
