 ...
 * 요청을 수신해서 처리한 App의 대문 역할을 하는 클래스
 ...
 * 5. 사용자의 요청을 해당 클래스의 doGet(), doPost() method로 전당ㅇ르 수행
 * 
 ...
 * 4. servlet 클래스가 있으면 이 클래스 들도 모든 컴파일을 수행하고
 * 	객체로 선언, 생성하여 container에 리스트를 올려두고
 * 
