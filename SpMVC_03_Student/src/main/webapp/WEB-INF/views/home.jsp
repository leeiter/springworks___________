...
header {
	...
	color : white; /* header box 내의 문자열의 글자색을 지정 */
...
<section>
	<article>
		<p><font size=30pt color=blue face=궁서>여기는 본문부분 입니다</font></p>
		<p><font style="font-size:50pt; color=red; background-color:yellow;">여기는 또다른 본문입니다.</font></p>
		<p>여기는 나의 이야기 입니다</p>
		...
		<p><a href = "https://naver.com/">네이버 바로가기</a>
			<a href = "https://daum.net/">다음 바로가기</a></p>
	</article>
</section>

<footer>
	<address>CopyRight &copy; jesgipne@hanmail.net</address>
</footer>
</body>
</html>