...
public class PetService {
	...
	public List<GoPetVO> getRestVOList(String s_cat, String s_text) throws UnsupportedEncodingException {
		
		String queryString = this.getQueryHeader();
		try {
			if(s_cat.equalsIgnoreCase("ADDR")) {
				queryString += "&address=" + URLEncoder.encode(s_cat, "UTF-8");
			} else {
